    ...
    render(){
        return(
            ...
            <div className="amor__container">
                <ul className="amor__container__list">
                    {this.state.data.map(e =>{ return( <li className="amor__container__list__item" key={e.id}> 
        <p> {e.id} {e.name} {e.puesto} {e.status} <button onClick={this.killLover.bind(this, e.id)} >Matar</button> <button onClick={this.proveLover.bind(this, e.id)} >Probar</button> </p> 
                    </li>)})}
                </ul>
